...
INSERT INTO `fsraiDatabase`.`USER` (`ID`, `CREATED_AT`, `UPDATED_AT`, `FIRSTNAME`, `LASTNAME`, `DATE_OF_BIRTH`, `DESCRIPTION`, `PICTURE`, `EMAIL`, `PASSWORD`, `ROLE_ID`) VALUES (3, DEFAULT, NULL, 'Admin', 'Admin', '01.01.4165', 'sfgfdsgnbsd', NULL, 'admin', 'admin', 1);
