...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fsraidatabase`.`getUserMemberHistory` (`ID` INT, `START_DATE` INT, `END_DATE` INT, `MEMBER_ID` INT, `FUNCTION_FSR_ID` INT, `FIRSTNAME` INT, `LASTNAME` INT, `DATE_OF_BIRTH` INT, `DESCRIPTION` INT, `PICTURE` INT);
