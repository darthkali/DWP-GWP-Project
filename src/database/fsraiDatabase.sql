...
INSERT INTO `fsraiDatabase`.`USER` (`ID`, `CREATED_AT`, `UPDATED_AT`, `FIRSTNAME`, `LASTNAME`, `DATE_OF_BIRTH`, `DESCRIPTION`, `PICTURE`, `EMAIL`, `PASSWORD`, `ROLE_ID`) VALUES (3, DEFAULT, NULL, 'Admin', 'Admin', '01.01.2001', 'sfgfdsgnbsd', NULL, 'admin', 'admin', 1);
...
START TRANSACTION;
USE `fsraiDatabase`;
INSERT INTO `fsraiDatabase`.`BOOKING` (`ID`, `CREATED_AT`, `UPDATED_AT`, `EVENTS_ID`, `USER_ID`) VALUES (1, DEFAULT, NULL, 1, 1);
INSERT INTO `fsraiDatabase`.`BOOKING` (`ID`, `CREATED_AT`, `UPDATED_AT`, `EVENTS_ID`, `USER_ID`) VALUES (2, DEFAULT, NULL, 1, 2);
