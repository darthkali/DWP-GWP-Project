...
-- -----------------------------------------------------
-- Placeholder table for view `fsraidatabase`.`geteventinfo_WRONG_SCHEMA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fsraidatabase`.`geteventinfo_WRONG_SCHEMA` (`ID` INT, `NAME` INT, `DATE` INT, `DESCRIPTION` INT, `PICTURE` INT, `LOCATION_ID` INT, `STREET` INT, `NUMBER` INT, `ZIPCODE` INT, `CITY` INT, `ROOM` INT);

-- -----------------------------------------------------
-- View `fsraidatabase`.`geteventinfo_WRONG_SCHEMA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fsraidatabase`.`geteventinfo_WRONG_SCHEMA`;
DROP VIEW IF EXISTS `fsraidatabase`.`geteventinfo_WRONG_SCHEMA` ;
USE `fsraidatabase`;
