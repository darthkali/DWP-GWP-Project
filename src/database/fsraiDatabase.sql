...
INSERT INTO `fsraiDatabase`.`USER` (`ID`, `CREATED_AT`, `UPDATED_AT`, `FIRSTNAME`, `LASTNAME`, `DATE_OF_BIRTH`, `DESCRIPTION`, `PICTURE`, `EMAIL`, `PASSWORD`, `ROLE_ID`) VALUES (3, DEFAULT, NULL, 'Admin', 'Admin', '01.01.2000', 'Admin zum Test', NULL, 'admin', 'admin', 1);
