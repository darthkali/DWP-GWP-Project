<div class="SitePicture" id="fadeInImg">
    <img class="center" src="<?=PAGE_IMAGE_PATH.'programmer.png'?>" alt = "Picture that´s define a programmer"> <!-- TODO: anderes Bild oder Titel-->
</div>
<div class="Content" id="fadeIn">
    ...
    <p><span id="s3-t-firma">Fachschaftsrat Angewandte Informatik</span><br><span id="s3-t-ansprechpartner">Danny Steinbrecher</span><br><span id="s3-t-strasse">Fachhochschule Erfurt</span><br><span id="s3-t-plz">99999</span> <span id="s3-t-ort">Erfurt</span></p><p></p>
